    ...
    <svg className={className} viewBox="0 0 325 79">
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ssspill-grad">
          <stop stopColor="#FFC526" stopOpacity="1" offset="55%" />
          <stop stopColor="#FFE699" stopOpacity="1" offset="100%" />
        </linearGradient>
      </defs>
      <g fill="url(#ssspill-grad)">
        <rect width="100%" height="40" fill="#FFC526" />
      ...
      <g fill="white" className="relative -z-50">
